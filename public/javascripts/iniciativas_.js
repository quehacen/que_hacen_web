...
function quitaFiltro(filtro){
	...
	if(url=="") window.location.href="iniciativas_";
	window.location.href="iniciativas_#"+url;
}
...
function anadeFiltro(filtro,tipoFiltro){
	...
	if(url!=false) window.location.href="iniciativas_#"+url;
}
...
function htmlIniciativas(iniciativas){      
	...
	var numInic=1;
        _.each(iniciativas,function(inic){
			...
			masInic+='<li class="iniciativa"><i class="fa fa-circle" style="display:inline-block"> </i> '+inic.titulo+' '+enlaceExt;
